...
const hero_contents = {
  title: <> <span className="tp-highlight"> <HighlightSix /> <i>Meet our team at BigBuddy</i>
  </span> </>,
  sm_text: <></>,
              ...
              <div className="tp-hero-section-box tp-bp-hero-section-box">
                ...
                <div className="tp-hero-three-button-box d-flex align-items-center wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1.1s">
                  <div className="xs-bottom-space">
                    <Link href="/contact">
                      <a className="tp-btn-skymr-55"></a>
                    </Link>
                  </div>
                  <div onClick={() => setIsVideoOpen(true)}
                    className="tp-hero-paly-button hero-paly-button  z-index-1">
                    <button className="popupdeo"><i className="flay"></i></button>
